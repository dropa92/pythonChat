...
class GUI:
    ...
    def receive_message_from_server(self, so):
        while True:
            ...
            if "joined" in message:
                ...
                message = user + " has joined This chat"
    ...
    def display_name_section(self):
        frame = Frame()
        Label(frame, text='Enter your name For Chat:', font=("Helvetica", 16)).pack(side='left', padx=10)
    ...
    def display_chat_box(self):
        frame = Frame()
        Label(frame, text='Python Chat Box:', font=("Serif", 12)).pack(side='top', anchor='w')
    ...
    def on_join(self):
        if len(self.name_widget.get()) == 0:
            messagebox.showerror(
                "Enter your User name", "Enter your name to enable sending a message")
            return
